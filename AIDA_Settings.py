...
#background = 0. positive float
#sigma_det = 5 positive float
#dark_image = None image file
...
#zeta = 3.  ratio (positive)         # ratio to compensate/weight gradient/laplacian calculation
...
#lambda_OTF_scaling = 1.0           # default = 1.0  positive
...
#output_intermediate_files_level = 0    # default = 0 integer
